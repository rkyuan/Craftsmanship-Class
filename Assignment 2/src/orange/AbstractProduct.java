...
public abstract class AbstractProduct implements Product{
	...
	public static Product make(ProductType productType,SerialNumber serialNumber, Optional<Set<String>> Description)
		...
		if (productType.getP().checkNum(serialNumber)){
			return productType.getP().makeOther(serialNumber, Description);
		}
	...
	public void process(Exchange request, RequestStatus status)
			throws ProductException {
		throw new ProductException(this.getProductType(),this.getSerialNumber(),ErrorCode.UNSUPPORTED_OPERATION);
